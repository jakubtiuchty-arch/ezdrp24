      ...
      <div className="w-full max-w-sm">
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-bold text-slate-900">Panel klienta</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="email@instytucja.gov.pl"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-10 py-2.5 rounded-lg border border-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <p className="text-center text-sm text-slate-500">
              Nie masz konta? <Link href="/panel/rejestracja" className="text-violet-600 hover:underline font-medium">Zarejestruj się</Link>
            </p>
          </form>
        </div>
      </div>
